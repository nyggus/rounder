...
def _do(func, obj, digits, use_copy):
    ...
    dispatch_table = {
        ...
        int: convert_number,
        bool: convert_number,
        decimal.Decimal: convert_number,
        complex: convert_complex,
        list: convert_list,
        tuple: convert_tuple,
        collections.namedtuple: convert_namedtuple,
        typing.NamedTuple: convert_namedtuple,
        set: convert_set,
        frozenset: convert_set,
        dict: convert_dict,
        collections.OrderedDict: convert_dict,
        collections.Counter: convert_dict,        
        collections.OrderedDict: convert_dict,
        array.array: convert_array,
        collections.deque: convert_deque,
        str: lambda obj: obj,
    }
    if use_copy:
        try:
